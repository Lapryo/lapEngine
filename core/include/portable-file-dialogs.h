...
#undef PFD_OSX_ICON
        ...
        else if (is_zenity())
        {
            ...
            {
            case choice::ok_cancel:
                command.insert(command.end(), {"--question", "--ok-label=OK", "--cancel-label=Cancel"});
                break;
            case choice::yes_no:
                ...
                break;
            case choice::yes_no_cancel:
                command.insert(command.end(), {"--question", "--switch", "--extra-button", "No", "--extra-button", "Yes", "--extra-button", "Cancel"});
                break;
            case choice::retry_cancel:
                command.insert(command.end(), {"--question", "--switch", "--extra-button", "Retry", "--extra-button", "Cancel"});
                break;
            case choice::abort_retry_ignore:
                command.insert(command.end(), {"--question", "--switch", "--extra-button", "Abort", "--extra-button", "Retry", "--extra-button", "Ignore"});
                break;
            default:
                switch (_icon)
                {
